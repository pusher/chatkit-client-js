...
var current_user_1 = __webpack_require__(11);
...
var chat_manager_1 = __webpack_require__(9);
...
var token_provider_1 = __webpack_require__(6);
var user_subscription_1 = __webpack_require__(21);
...
var GlobalUserStore = (function () {
    ...
    GlobalUserStore.prototype.getUser = function (id, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose('Error fetching user information:', error);
            onError(error);
        });
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var pusher_platform_1 = __webpack_require__(2);
var basic_message_enricher_1 = __webpack_require__(12);
var cursor_subscription_1 = __webpack_require__(13);
var cursor_types_1 = __webpack_require__(14);
var payload_deserializer_1 = __webpack_require__(0);
var presence_subscription_1 = __webpack_require__(15);
var room_store_1 = __webpack_require__(16);
var room_subscription_1 = __webpack_require__(17);
...
var CurrentUser = (function () {
    ...
    CurrentUser.prototype.createRoom = function (options, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose('Error creating room:', error);
            onError(error);
        });
    };
    ...
    CurrentUser.prototype.updateRoom = function (roomId, options, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error updating room " + roomId + ":", error);
            onError(error);
        });
    };
    CurrentUser.prototype.deleteRoom = function (roomId, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error deleting room " + roomId + ":", error);
            onError(error);
        });
    };
    CurrentUser.prototype.addOrRemoveUsers = function (roomId, userIds, membershipChange, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error when attempting to " + membershipChange + " users from room " + roomId + ":", error);
            onError(error);
        });
    };
    CurrentUser.prototype.joinRoom = function (roomId, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error joining room " + roomId + ":", error);
            onError(error);
        });
    };
    CurrentUser.prototype.leaveRoom = function (roomId, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error leaving room " + roomId + ":", error);
            onError(error);
        });
    };
    ...
    CurrentUser.prototype.isTypingIn = function (roomId, onSuccess, onError) {
        var _this = this;
        var now = Date.now();
        var sent = this.typingRequestSent[roomId];
        var eventName = 'typing_start';
        var eventPayload = {
            name: 'typing_start',
            user_id: this.id,
        };
        if (!sent || now - sent > constants_1.TYPING_REQ_TTL - constants_1.TYPING_REQ_LEEWAY) {
            ...
            this.apiInstance
                ...
                _this.apiInstance.logger.verbose("Error sending " + eventName + " event in room " + roomId + ":", error);
                onError(error);
            });
        }
        else {
    ...
    CurrentUser.prototype.setCursor = function (position, room, onSuccess, onError) {
        var _this = this;
        ...
        this.cursorsInstance
            ...
            .then(onSuccess)
            .catch(function (err) {
            _this.cursorsInstance.logger.verbose("Error setting cursor in room " + room.name + ":", err);
            onError(err);
        });
    };
    CurrentUser.prototype.sendMessage = function (options, onSuccess, onError) {
        var _this = this;
        var attachment = options.attachment, rest = __rest(options, ["attachment"]);
        var completeOptions = __assign({ user_id: this.id }, rest);
        if (attachment !== undefined) {
            if (this.isDataAttachment(attachment)) {
                var file = attachment.file, name = attachment.name;
                this.uploadFile(file, name, options.roomId)
                    .then(function (fileRes) {
                    _this.sendMessageWithCompleteOptions(__assign({ attachment: fileRes, user_id: _this.id }, rest), onSuccess, onError);
                })
                    .catch(function (error) {
                    onError(error);
                    return;
                ...
                var link = attachment.link, type = attachment.type;
    ...
    CurrentUser.prototype.subscribeToRoom = function (room, roomDelegate, messageLimit) {
        ...
        this.cursorsReq.then(function () {
            room.subscription = new room_subscription_1.default({
                basicMessageEnricher: new basic_message_enricher_1.default(_this.userStore, room, _this.apiInstance.logger),
                delegate: roomDelegate,
                logger: _this.apiInstance.logger,
            });
            ...
            _this.subscribeToCursors(room, roomDelegate);
        });
    };
    CurrentUser.prototype.fetchMessagesFromRoom = function (room, fetchOptions, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            _this.userStore.fetchUsersWithIds(userIdsToFetch, function (users) {
                var messageEnricher = new basic_message_enricher_1.default(_this.userStore, room, _this.apiInstance.logger);
                ...
                _this.apiInstance.logger.verbose("Error fetching users with ids " + userIdsToFetch + ":", error);
            });
        })
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error fetching messages froom room " + room.name + ":", error);
            onError(error);
        });
    };
    ...
    CurrentUser.prototype.sendMessageWithCompleteOptions = function (options, onSuccess, onError) {
        var _this = this;
        this.apiInstance
            .request({
            json: options,
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose("Error sending message to room " + options.roomId + ":", error);
            onError(error);
        });
    };
    ...
    CurrentUser.prototype.getRooms = function (path, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.verbose('Error when getting instance rooms:', error);
            onError(error);
        });
    };
    return CurrentUser;
...
var CursorSubscription = (function () {
    ...
    CursorSubscription.prototype.handleEvent = function (event) {
        ...
        var basicCursor = payload_deserializer_1.default.createBasicCursorFromPayload(data);
        this.logger.verbose("Room received cursor for: " + basicCursor.userId);
        this.handleCursorSetInternal(basicCursor);
        this.enrich(basicCursor, function (cursor) {
            if (_this.delegate && _this.delegate.cursorSet) {
                _this.delegate.cursorSet(cursor);
            }
        }, function (error) {
            _this.logger.debug('Error receiving cursor:', error);
        });
    };
    CursorSubscription.prototype.enrich = function (basicCursor, onSuccess, onError) {
        var _this = this;
        this.userStore.user(basicCursor.userId, function (user) {
            onSuccess({
            ...
            _this.logger.debug("Unable to find user with id " + basicCursor.userId + ". Error:", error);
            onError(error);
        });
    };
...
var RoomStore = (function () {
    ...
    RoomStore.prototype.getRoom = function (id, onSuccess, onError) {
        ...
        this.apiInstance
            ...
            .catch(function (error) {
            _this.apiInstance.logger.debug("Error fetching room " + id + ":", error);
            onError(error);
        });
    };
    return RoomStore;
...
Object.defineProperty(exports, "__esModule", { value: true });
var room_user_store_1 = __webpack_require__(19);
var Room = (function () {
